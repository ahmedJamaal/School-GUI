...
public class TableForm extends javax.swing.JFrame {
    ...
    private void pasteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pasteActionPerformed
        ...
        if(col >= 0 && row >= 0)
        {
            if(cell != null)
            {
                errors.setText("paset: " + cell);
                table.setValueAt(cell, row, col);
                copy.setEnabled(true);
            }
            else
                errors.setText("This ia an empty cell !!");
        }
        else
        {
            errors.setText("please, select a cell");
        }
    ...
    private void copyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_copyActionPerformed
        ...
        if(col >= 0 && row >= 0)
        {
            // save selected cell in variabel 
            if(table.getValueAt(row, col) != null)
            {
                cell = table.getValueAt(row, col).toString();
                errors.setText("copy: " + cell);
